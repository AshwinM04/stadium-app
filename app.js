...
const STADIUM_CONFIGS = {
  metlife: {
    ...
    facilities: [
      ...
      { id: 'restroom_129', category: 'bathroom', section: 129, level: 100,
        shortName: 'Restroom (129)',
        name: { en: 'Restroom (Sec 129)', es: 'Baño (Sec 129)', fr: 'Toilettes (Sec 129)', de: 'Toilette (Sekt 129)', pt: 'Banheiro (Sec 129)', ja: 'トイレ (129)' } },
